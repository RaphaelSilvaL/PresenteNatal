...
button.addEventListener("click", () => {
    ...
    setTimeout(() => {
        showText("Ninguém entende como tudo aconteceu tão rápido, nem mesmo a gente, mas você foi o meu inesperado mais esperado! Feliz Natal Moça da Fármacia!!!", 350);
    }, 1000);
});
